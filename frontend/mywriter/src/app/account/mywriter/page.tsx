  ...
  async function handleSend() {
    ...
    try {
      ...
      if (data.error) {
        ...
        const derivativeAsset = registerDerivativeCommercialExpandedOutline(IPresponse, data)
        console.log(data)
        console.log("Is this getting printed?")
        console.log(`View outline on the explorer: https://explorer.story.foundation/ipa/${IPresponse.ipId}`)
        console.log(`View outline on the explorer: https://explorer.story.foundation/ipa/${derivativeAsset.ipId}`)
