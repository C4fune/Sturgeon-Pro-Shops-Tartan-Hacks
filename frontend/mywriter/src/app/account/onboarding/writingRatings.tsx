...
export function WritingReviewOne(props: {
  writingScore: number;
  setWritingScore: Dispatch<SetStateAction<number>>;
  previousPage: () => void;
  nextPage: () => void;
}) {
  return (
    <WritingReview
      writing={`
        ...
        `}
      writingScore={props.writingScore}
      setWritingScore={props.setWritingScore}
...
export function WritingReviewTwo(props: {
  writingScore: number;
  setWritingScore: Dispatch<SetStateAction<number>>;
  previousPage: () => void;
  nextPage: () => void;
...
export function WritingReviewThree(props: {
  writingScore: number;
  setWritingScore: Dispatch<SetStateAction<number>>;
  previousPage: () => void;
  nextPage: () => void;
...
export function WritingReviewFour(props: {
  writingScore: number;
  setWritingScore: Dispatch<SetStateAction<number>>;
  previousPage: () => void;
  nextPage: () => void;
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-8 space-y-8">
          <p className="text-xl text-slate-700 text-center mb-8">
            Rate the following excerpt to help us match you with authors you'll
            love
          </p>

          <p className="text-base text-slate-700 bg-eggshell p-6 rounded-lg border-l-4 border-battleship leading-relaxed">
            {props.writing}
          </p>
