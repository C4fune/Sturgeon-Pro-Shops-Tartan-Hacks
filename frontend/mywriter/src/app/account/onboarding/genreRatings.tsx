...
export default function ChooseGenres(props: {genreRatings: GenreRatings, setGenreRatings: Dispatch<SetStateAction<GenreRatings>>, nextPage: () => void}) {
    return (
            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-white rounded-2xl shadow-lg p-8 space-y-8">
                    ...
                    <div className="space-y-8">
                        <GenreSlider genre="sci-fi" value={props.genreRatings} setValue={props.setGenreRatings} />
...
function GenreSlider(props: {genre: string, value: any, setValue: Dispatch<SetStateAction<GenreRatings>>}) {
